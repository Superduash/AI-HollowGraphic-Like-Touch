...
- 320x240 hand processing
- smoother cursor interpolation + damping
- gestures: index-only move, thumb+index pinch click/drag, thumb+middle pinch right click, peace-sign scroll, open palm Task View, closed fist pause
